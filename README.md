...
Third, it can be interesting to see how the commands listed above can be packaged into a Bash script — that is, how Bash imperatives can be controlled and orchestrated by procedures (functions).
